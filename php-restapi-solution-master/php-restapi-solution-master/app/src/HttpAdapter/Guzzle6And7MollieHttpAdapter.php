...
use _PhpScopera9ad0faf21db\Composer\CaBundle\CaBundle;
use _PhpScopera9ad0faf21db\GuzzleHttp\Client;
use _PhpScopera9ad0faf21db\GuzzleHttp\ClientInterface;
use _PhpScopera9ad0faf21db\GuzzleHttp\Exception\GuzzleException;
use _PhpScopera9ad0faf21db\GuzzleHttp\HandlerStack;
use _PhpScopera9ad0faf21db\GuzzleHttp\Psr7\Request;
use _PhpScopera9ad0faf21db\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use _PhpScopera9ad0faf21db\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public function __construct(\_PhpScopera9ad0faf21db\GuzzleHttp\ClientInterface $httpClient)
    {
    ...
    public static function createDefault()
    {
        ...
        $handlerStack = \_PhpScopera9ad0faf21db\GuzzleHttp\HandlerStack::create();
        $handlerStack->push($retryMiddlewareFactory->retry());
        $client = new \_PhpScopera9ad0faf21db\GuzzleHttp\Client([\_PhpScopera9ad0faf21db\GuzzleHttp\RequestOptions::VERIFY => \_PhpScopera9ad0faf21db\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScopera9ad0faf21db\GuzzleHttp\RequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, \_PhpScopera9ad0faf21db\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    {
        $request = new \_PhpScopera9ad0faf21db\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScopera9ad0faf21db\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScopera9ad0faf21db\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function versionString()
    {
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            return "Guzzle/" . \_PhpScopera9ad0faf21db\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            return "Guzzle/" . \_PhpScopera9ad0faf21db\GuzzleHttp\ClientInterface::VERSION;
        }
        return null;
    }
}
